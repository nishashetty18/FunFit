...
<nav>
    ...
    <div class="row">
    		...
    		<h3 class="text-center" style="color:#36455F;"><b>List of Participants </b></h3>
    	<br />
    		<div class="container text-left">
    			&nbsp;&nbsp;&nbsp;&nbsp;
    			<a href="<%=request.getContextPath()%>/new" class="btn btn-primary"style="background-color:#36455F;margin-left:7%">Add New Participant</a>
    		...
    		<table class="table table-bordered" style="text-align:center;--bs-table-bg:#C5C6C7;">
    			...
    			<tbody>
    				<c:forEach var="part" items="${viewlist}">
    					<tr>
    						...
    						&nbsp;&nbsp;&nbsp;&nbsp;
    						<a class="btn btn-danger"href="delete?id=<c:out value='${part.id}'/>" >Delete</a></td>
    					</tr>
    				</c:forEach>
    			</tbody>
    		</table>
